...
public class ControladorEjemplo extends MouseAdapter {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == view.getBtnMensaje()){
            ...
            JOptionPane.showMessageDialog(view, "Este es el ejemplo","Titulo personalizado",JOptionPane.WARNING_MESSAGE,icono);
        ...
        if (e.getSource() == view.getBtnOpcion()){
            ...
            int respuesta = JOptionPane.showConfirmDialog(view,"Estas seguro de querer borrar el registro","Confirmacion",JOptionPane.YES_NO_OPTION);
